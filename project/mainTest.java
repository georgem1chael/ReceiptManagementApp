...
public class mainTest {
	...
	public static void main(String[] args) {
		...
		User a = new User("anna", Role.MANAGER);
		User b = new User("bob", Role.ACCOUNTANT);
		User b1 = new User("other bob", Role.ACCOUNTANT);
		User c = new User("charlie", Role.SALESPERSON);
